        ...
        */
        L.Control.Layers.Tree = L.Control.Layers.extend({
                ...
                if (text) {
                    ...
                    L.DomEvent.on(o, 'click keydown', function(e) {
                        if (e.type !== 'keydown' || e.keyCode === 32) {
                            ...
                            if(text === 'Tutup' || text === '-' || text === 'x') {
                                $(o).hide();
                                $(o).parent().find('.leaflet-layerstree-expand-collapse').eq(1).show();
                            }

                            if(text === 'Buka' || text === '+') {
                                $(o).hide();
                                $(o).parent().find('.leaflet-layerstree-expand-collapse').eq(0).show();
                            }
                        }
                    }, this);
                }
            ...
            _iterateTreeLayout: function(tree, container, overlay, selAllNodes, noShow) {
                ...
                $('<span class="checkmark"></span>').insertAfter(name);
