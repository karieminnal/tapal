...
class MY_Controller extends CI_Controller
{
	...
	function __construct()
	{
		...
		// Gunakan tema gis kalau setting tema kosong atau folder di desa/themes untuk tema pilihan tidak ada
	...
	function set_template($template_file = 'template.php')
	{
		...
		if (is_file($template_file_path))
			...
			$this->template = '../../themes/gis/' . $template_file;
	}
...
class Web_Controller extends MY_Controller
{
	...
	/*
	 * Jika file theme/view tidak ada, gunakan file gis/view
