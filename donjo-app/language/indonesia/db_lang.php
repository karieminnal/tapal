...
$lang['db_unable_to_connect'] = '<h3>Ada kesalahan dalam pemasangan </h3>Aplikasi tidak bisa terhubung ke database.<br />Silakan salin/tempel folder desa-contoh sebagai folder desa dan periksa isi berkas desa/config/database.php. Pastikan pada bagian "Data Konfigurasi MySQL yang disesuaikan" terisi dengan benar.<p></p>';
