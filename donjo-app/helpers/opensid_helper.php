...
// tambah helper
define("API_MAP", base_url() . "api_custom/");
...
define("PERUNTUKAN_PERSIL", serialize(array(
	"1" => "Pertanian",
	"2" => "Peternakan"
)));
define("TUTUPAN_LAHAN_JENIS", serialize(array(
	"1" => "Fasilitas Umum",
	"2" => "Pemukiman",
	"3" => "Perkebunan",
	"4" => "Tanah Kering",
...
function gambar_desa($nama_file, $type = FALSE, $file = FALSE)
{
	...
	$default = ($type)  ? 'pintasia_kantor.jpg' : 'pintasia_logo.png';
