...
class Penduduk extends Admin_Controller
{
	...
	{
		parent::__construct();
		$this->load->model(['penduduk_model', 'keluarga_model', 'wilayah_model', 'referensi_model', 'web_dokumen_model', 'header_model', 'config_model', 'program_bantuan_model', 'lapor_model']);
		$this->_header = $this->header_model->get_data();
		$this->modul_ini = 2;
		$this->sub_modul_ini = 21;
		$this->_set_page = ['50', '100', '200', '500', '1000'];
		$this->_list_session = ['filter', 'status_dasar', 'sex', 'agama', 'dusun', 'rw', 'rt', 'cari', 'umur_min', 'umur_max', 'pekerjaan_id', 'status', 'pendidikan_sedang_id', 'pendidikan_kk_id', 'status_penduduk', 'judul_statistik', 'cacat', 'cara_kb_id', 'akta_kelahiran', 'status_ktp', 'id_asuransi', 'status_covid', 'penerima_bantuan', 'log', 'warganegara', 'menahun', 'golongan_darah', 'hamil', 'umurx'];
	}
	...
	public function statistik($tipe = 0, $nomor = 0, $sex = NULL)
	{
		...
		switch ($tipe) {
			case '0':
				$_SESSION['pendidikan_kk_id'] = $nomor;
				$pre = "PENDIDIKAN DALAM KK : ";
				break;
			case 1:
				$_SESSION['pekerjaan_id'] = $nomor;
				$pre = "PEKERJAAN : ";
				break;
			case 2:
				$_SESSION['status'] = $nomor;
				$pre = "STATUS PERKAWINAN : ";
				break;
			case 3:
				$_SESSION['agama'] = $nomor;
				$pre = "AGAMA : ";
				break;
			case 4:
				$_SESSION['sex'] = $nomor;
				...
				break;
			case 5:
				$_SESSION['warganegara'] = $nomor;
				$pre = "WARGANEGARA : ";
				break;
			case 6:
				$_SESSION['status_penduduk'] = $nomor;
				$pre = "STATUS PENDUDUK : ";
				break;
			case 7:
				$_SESSION['golongan_darah'] = $nomor;
				$pre = "GOLONGAN DARAH : ";
				break;
			case 9:
				$_SESSION['cacat'] = $nomor;
				$pre = "CACAT : ";
				break;
			case 10:
				$_SESSION['menahun'] = $nomor;
				$pre = "SAKIT MENAHUN : ";
				break;
			case 13:
				...
				break;
			case 14:
				$_SESSION['pendidikan_sedang_id'] = $nomor;
			...
			case 18:
				...
				break;
			case 19:
				$_SESSION['id_asuransi'] = $nomor;
				$pre = "JENIS ASURANSI : ";
				break;
			case 'covid':
				$_SESSION['status_covid'] = $nomor;
				$pre = "STATUS COVID : ";
				break;
			case 'bantuan_penduduk':
				$_SESSION['penerima_bantuan'] = $nomor;
				$pre = "PENERIMA BANTUAN (PENDUDUK) : ";
				break;
		}
	...
	public function statistik_download($tipe = 0, $nomor = 0, $sex = NULL, $id_cluster)
	{
		$this->clear_session();
		// Untuk tautan TOTAL di laporan statistik, di mana arg-2 = sex dan arg-3 kosong
		// kecuali untuk laporan wajib KTP
		...
		$data['main'] = $this->penduduk_model->list_data(0, 0, 10000);
		$data['namafile'] = $_SESSION['judul_statistik'];
		$this->load->view('sid/kependudukan/penduduk_excel', $data);
		// clear filter after download
		$this->session->unset_userdata($this->_list_session);
	}
	...
	{
		$target_dir = "desa/upload/excel/";
		$target_file = $target_dir . basename($_FILES["fileToUpload"]["name"]);
		if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
			echo "The file " . basename($_FILES["fileToUpload"]["name"]) . " has been uploaded.";
			$this->penduduk_model->readcsv($target_file);
			redirect('penduduk');
		} else {
