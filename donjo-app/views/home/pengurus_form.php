					...
					<div class="box box-primary">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input id="alamat" name="alamat" class="form-control input-sm" type="text" placeholder="Alamat" value="<?= $pamong['alamat'] ?>"></input>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label" for="lat">Latitude</label>
								<div class="col-sm-7">
									<input id="lat" name="lat" class="form-control input-sm" type="text" placeholder="Latitude" value="<?= $pamong['lat'] ?>"></input>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label" for="lng">Longitude</label>
								<div class="col-sm-7">
									<input id="lng" name="lng" class="form-control input-sm" type="text" placeholder="Longitude" value="<?= $pamong['lng'] ?>"></input>
								</div>
							</div>
							<div class="form-group">
