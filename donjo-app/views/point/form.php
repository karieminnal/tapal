...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Pengaturan Jenis Lokasi</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_sid') ?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= site_url('point') ?>"><i class="fa fa-dashboard"></i> Daftar Jenis Lokasi</a></li>
					...
					<div class="box box-info">
						<div class="box-header with-border">
							<a href="<?= site_url("point") ?>" class="btn btn-social btn-flat btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Tambah Artikel">
								<i class="fa fa-arrow-circle-left "></i>Kembali ke Daftar Jenis Lokasi
							</a>
						</div>
						<div class="box-body">
							<div class="form-group">
								<label for="nama" class="col-sm-2 control-label">Nama Jenis</label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input id="urutan" class="form-control input-sm" maxlength="5" type="number" name="urutan" value="<?= $point['urutan'] ?>">
								</div>
							</div>
							<div class="form-group">
