...
<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Pengaturan Jenis Lokasi</li>
		</ol>
	</section>
														...
														<table class="table table-bordered table-striped dataTable table-hover">
															<thead class="bg-gray disabled color-palette">
																<tr>
																	...
																	<?php endif; ?>
																	<?php if ($o == 6) : ?>
																		<th nowrap><a href="<?= site_url("point/index/$p/5") ?>">Urutan <i class='fa fa-sort-asc fa-sm'></i></a></th>
																	<?php elseif ($o == 5) : ?>
																		<th nowrap><a href="<?= site_url("point/index/$p/6") ?>">Urutan <i class='fa fa-sort-desc fa-sm'></i></a></th>
																	<?php else : ?>
																		<th nowrap><a href="<?= site_url("point/index/$p/5") ?>">Urutan <i class='fa fa-sort fa-sm'></i></a></th>
																	<?php endif; ?>
																	<th>Simbol</th>
																</tr>
															</thead>
