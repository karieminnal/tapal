															...
															<?php foreach ($leuit_panen as $produksi) : ?>
																<tr>
																	...
																	<td>
																		...
																		<a href="javascript:;" data-href="<?= site_url("leuit_panen/delete/$produksi[id]") ?>" class="btn bg-maroon btn-flat btn-sm" title="Hapus" data-toggle="modal" data-target="#confirm-delete">
