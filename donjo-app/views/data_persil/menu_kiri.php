<div class="box box-info">
	...
	<div class="box-body no-padding">
		<ul class="nav nav-pills nav-stacked">
			...
			<li <?php if ($this->tab_ini == 13) : ?>class="active" <?php endif; ?>><a href="<?= site_url('data_persil/clear') ?>"><i class='fa fa-chevron-right'></i> Persil</a></li>
			<li <?php if ($this->tab_ini == 16) : ?>class="active" <?php endif; ?>><a href="<?= site_url('tutupan_lahan/clear') ?>"><i class='fa fa-chevron-right'></i> Tutupan Lahan</a></li>
			<li <?php if ($this->tab_ini == 17) : ?>class="active" <?php endif; ?>><a href="<?= site_url('tutupan_lahan_jenis') ?>"><i class='fa fa-chevron-right'></i> Jenis Tutupan Lahan</a></li>
