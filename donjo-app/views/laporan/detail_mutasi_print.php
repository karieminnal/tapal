...
<body>
  <div id="container">
    ...
    <div id="body">
      <table>
        <tr><td colspan="19" class="no-border" style="font-size: 14pt; text-align: center; font-weight: bold">BUKU PEMBANTU MUTASI HARIAN KEPENDUDUKAN (LAMPID)</td></tr>
        <tr><td colspan="19" class="no-border" style="font-size: 14pt; text-align: center; font-weight: bold">DESA <?= strtoupper($config['nama_desa']) ?></td></tr>
        <tr><td colspan="19" class="no-border" style="font-size: 14pt; text-align: center; font-weight: bold">KECAMATAN <?= strtoupper($config['nama_kecamatan']) ?></td></tr>
        <tr><td colspan="19" class="no-border" style="font-size: 14pt; text-align: center; font-weight: bold">BULAN <?= strtoupper($bln) ?> <?= $tahun ?></td></tr>
      </table>
      <br>
      <?php include("donjo-app/views/laporan/tabel_detail_mutasi.php"); ?>
      <table class="tftable">
        <tr>
        </tr>
        <tr>
