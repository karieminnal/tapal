...
<body>
  <div id="container">
    ...
    <div id="body">
      <table>
        <tr><td colspan="5" class="no-border" style="font-size: 14pt; text-align: center;">DAFTAR JUMLAH KEPALA KELUARGA</td></tr>
        <tr><td colspan="5" class="no-border" style="font-size: 14pt; text-align: center; font-weight: bold">DESA <?= strtoupper($config['nama_desa']) ?></td></tr>
        <tr><td colspan="5" class="no-border" style="font-size: 14pt; text-align: center; font-weight: bold">KECAMATAN <?= strtoupper($config['nama_kecamatan']) ?></td></tr>
        <tr><td colspan="5" class="no-border" style="font-size: 14pt; text-align: center; font-weight: bold">BULAN <?= strtoupper($bln) ?> <?= $tahun ?></td></tr>
      </table>
      <br>
      <?php include("donjo-app/views/laporan/tabel_kk_per_dusun.php"); ?>
      <table class="tftable">
        <tr>
        </tr>
        <tr>
