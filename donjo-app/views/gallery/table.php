												...
												<div class="col-sm-12">
													<div class="row">
														<?php foreach ($main as $data) : ?>
															<div class="col-md-4" data-rel="popover" data-placement="left" data-content="<img style='width: 200px; height:auto' src=<?= AmbilGaleri($data['gambar'], 'kecil') ?>>">
																<div class="thumbnail thumbnail-gallery">
																	<img src=<?= AmbilGaleri($data['gambar'], 'kecil') ?>>
																	<div class="caption">
																		<input type="checkbox" name="id_cb[]" value="<?= $data['id'] ?>" />
																		<div class="title">Album : <?= $data['nama'] ?></div>
