...
<div class="row">
	...
	<div class='col-sm-4'>
		<div class='form-group'>
			<label for="no_kk_sebelumnya">Nomor KK</label>
			<input id="no_kk" name="no_kk" class="form-control input-sm nik" maxlength="30" type="text" placeholder="No KK" value="<?= strtoupper($penduduk['no_kk']) ?>"></input>
		</div>
	</div>
	<div class='col-sm-4'>
		<div class='form-group'>
