<?php class Penduduk_model extends MY_Model {
	...
	private function list_data_sql()
	{
		...
		$sql .= " WHERE 1 AND a2.id_desa= '$filterDesa' ";
		$sql .= $this->search_sql();
		$sql .= $this->filter_sql();
	...
	public function list_data($o=0, $offset=0, $limit=500)
	{
		...
		$select_sql .= "u.id, u.nik, u.tanggallahir, u.tempatlahir, u.foto, u.status, u.status_dasar, u.id_kk, u.nama, u.nama_ayah, u.nama_ibu, a2.dusun, a2.rw, a2.rt, d.alamat, d.no_kk AS no_kk, u.kk_level, u.tag_id_card, u.created_at, rc.id as status_covid,
