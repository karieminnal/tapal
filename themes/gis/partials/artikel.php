...
<?php if ($single_artikel["id"]) : ?>
	<div class="artikel" id="<?= 'artikel-' . $single_artikel['judul'] ?>">
		<?php if (trim($single_artikel['kategori']) != '') : ?>
			<div class="kategori-artikel mb-3"><span class="badge"><?= $single_artikel['kategori'] ?></span></div>
		<?php endif; ?>

		<h2 class="judul"><?= $single_artikel["judul"] ?></h2>
		<div class="sub-judul">
			<span><i class="fa fa-user"></i> <?= $single_artikel['owner'] ?></span>
			<span><i class="fa fa-clock-o"></i><?= tgl_indo2($single_artikel['tgl_upload']); ?></span>
			<span><i class="fa fa-eye"></i> <?= hit($single_artikel['hit']) ?></span>
